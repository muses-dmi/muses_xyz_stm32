##########################################################################################################################
# File automatically-generated by tool: [projectgenerator] version: [3.4.0] date: [Sat Oct 05 15:51:39 BST 2019] 
##########################################################################################################################
...
CPP_SOURCES = \
libs/src/semihost.cpp \
libs/src/sensel.cpp \
libs/src/circular_buffer.cpp \
libs/src/oled.cpp \
Src/main.cpp
...
$(BUILD_DIR)/$(TARGET).elf: $(OBJECTS) $(CPP_OBJECTS) Makefile
	$(CPP) $(OBJECTS) $(CPP_OBJECTS) $(LDFLAGS) -o $@
	$(SZ) $@
